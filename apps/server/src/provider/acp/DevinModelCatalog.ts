 ...
 * encodes. Fusion combos share one family with the primary model as a
 * lead axis. The sidekick's own speed token folds into the combo's speed since Devin only
